...
\lstinputlisting[caption=Playfair Cipher Implementation,language=C,basicstyle=\ttfamily\footnotesize, captionpos=t, numbers=left, breaklines=true]{playfair.c}
